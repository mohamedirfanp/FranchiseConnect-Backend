...
namespace FranchiseGRPCService.Migrations
{
    ...
    [Migration("20230708171346_new field added in franchise request model")]
    partial class newfieldaddedinfranchiserequestmodel
    {
            ...
            modelBuilder.Entity("FranchiseGRPCService.Models.FranchiseRequestModel", b =>
                {
                    ...
                    b.Property<string>("InvestmentBudget")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("investment_budget");
